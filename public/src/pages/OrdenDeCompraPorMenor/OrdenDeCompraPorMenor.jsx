...
import { buttonContainer, inputContainer, inputText, crud, centerAligned, editButton, scrollableTable,
 ...
 } from './OrdenDeCompraPorMenor.module.css'
import { Loading } from '../../components';

 const OrdenDeCompraPorMenor = () => {
  ...
  const submit = (event, id) => {
    ...
    if (id === 0) {
      axios.post("https://frail-maryanne-uvg.koyeb.app/create_orden_compra", {
        envio, 
        fecha, 
        total, 
        id_cliente,
...
export default OrdenDeCompraPorMenor